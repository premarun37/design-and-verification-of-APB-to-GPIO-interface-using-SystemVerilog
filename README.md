...
This repository contains the design and verification of an **AMBA APB to GPIO interface** implemented using **SystemVerilog**. The project demonstrates both RTL design and an object-oriented verification environment.
